...
1. [vue-manage-system](https://github.com/lin-xin/vue-manage-system):https://lin-xin.gitee.io/example/#/  ， 没有兼容移动端，比较简单，适合小项目。
...
1. [基于Gin + Vue + Element UI前后端分离的工单系统](https://github.com/lanyulei/ferry),有点简陋，适合小型项目
